...
before packages are loaded."
  ...
  ;;("t" "todo" entry (file "~/org/gtd.org")
    ;;"* TODO %?\n")
  ;;("f" "file note" entry (file+headline "~/org/fileNotes.org" "File notes")
    ;;"* %?\nEntered on %U\n  %i\n  %a")
  ...
  (setq org-capture-templates 
    '(
      ("i" "inbox" entry (file "~/org/inbox.org")
       "* %?\n")
      ("c" "coding" entry (file "~/org/coding.org")
       "* %?\n")
      ("g" "gtdTrello" entry (file+olp+datetree "~/org/gtdTrello.org")
       "* %x%?")
      ("s" "scene changes" entry (file+headline "~/org/sceneChanges.org" "Scene changes") (file "~/org/templates/sceneChangesTpl.txt"))
      )
  )
